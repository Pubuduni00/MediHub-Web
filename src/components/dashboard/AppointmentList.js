        ...
        <div style={{display:'flex',flexDirection:'column',gap:10}}>
          {todayAppts.map(appt=>(
            <div
              ...
              style={{display:'flex',alignItems:'center',gap:12,padding:'10px 14px',borderRadius:'var(--radius-md)',border:'1px solid var(--border)',cursor:'pointer',transition:'var(--transition)'}}
            ...
            >
              <div style={{width:38,height:38,borderRadius:'var(--radius-md)',background:'var(--primary-light)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                {/* Only show doctor name for staff */}
                <p style={{fontSize:12,color:'var(--text-muted)'}}>
                  {appt.type}{isStaff ? ` · ${appt.doctorName}` : ''}
                </p>
              </div>
