...
export default function DashboardPage() {
  ...
  const firstName = user?.name?.split(' ').find(w => !w.startsWith('Dr')) || user?.name?.split(' ')[0] || '';
  ...
  return (
    <div>
      ...
      <div style={{marginBottom:22}}>
        <h1 style={{fontSize:22,fontWeight:700,color:'var(--text-primary)'}}>{greeting}</h1>
      ...
      {/* Main Grid — no calendar on right */}
      <div className="dashboard-grid">
          ...
          <div className="card">
            ...
            <div className="table-wrapper">
              <table>
                <thead>
                  <tr>
                    <th>Patient</th><th>ID</th><th>Age</th><th>Blood Group</th><th>Status</th>
                  </tr>
                </thead>
                <tbody>
        ...
        {/* Right Column — alerts and symptoms only */}
